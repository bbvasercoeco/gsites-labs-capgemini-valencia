...
function comprueba_bbcode2html(contenedor)
{
	if(typeof bbcode2html != 'undefined') 
	{
	   ...
	   var miventana=window.open("","miventana","width=400,height=400,menubar=no,scrollbars=yes"); 
...
{     
	...
	// html_btn+=boton("Ayuda",contenedor);		 
	 ...
	 html_btn+='<option value="#073763" style="color:#073763;">texto BBVA';
